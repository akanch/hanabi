...
function Config(currentDeck, numBlueTokens, currentPlayer, playerList, discardPiles, correctGuesses, numWrongGuesses, handSlots, gameOn) { //config should be in its own file {
